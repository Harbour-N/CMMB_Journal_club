...
function [sensitivity,specificity,precision,truePosMag,falseNegMag,allPks,allResolution,allSites,allPMag,all_bPosAccuracy] = fQTLmodel_fineMapping_100516_long(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise)
