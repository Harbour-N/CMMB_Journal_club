function [] = fQTLmodel_timer(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise)
...
[sensitivity,specificity,truePosMag,falseNegMag] = fQTLmodel(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise);
