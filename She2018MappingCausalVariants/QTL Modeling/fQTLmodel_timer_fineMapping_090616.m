function [] = fQTLmodel_timer_fineMapping_090616(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise)
...
[sensitivity,specificity,precision,truePosMag,falseNegMag,allPks,allResolution,allSites,allPMag,allbPosAccuracy,allVariance] = fQTLmodel_fineMapping_090616(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise);
...
save(['fQTLmodel_fineMapping-Trials_',num2str(Trials),'_nSites_',num2str(nSites),...
