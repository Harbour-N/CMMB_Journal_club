function [] = fQTLmodel_timer_pval(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise,pval)
...
[sensitivity,specificity,truePosMag,falseNegMag] = fQTLmodel_pval(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise,pval);
