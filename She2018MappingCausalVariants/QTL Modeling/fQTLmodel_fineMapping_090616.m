...
function [sensitivity,specificity,precision,truePosMag,falseNegMag,allPks,allResolution,allSites,allPMag,all_bPosAccuracy,allVariance] = fQTLmodel_fineMapping_090616(Trials,nSites,cycles,nSegregants,genomeSize,RR,pSites,noise)
