...
r_S = 0.03  # /day # sensative cells proliferation rate
r_R = 0.5 * r_S # 0.5*r_S - 1*r_S # Resistiant cells proliferation rate
d_S = 0.2 * r_S # 0*r_S - 0.5*r_S # sensative cells death rate
d_R = 0.2 * r_S # 0*r_S - 0.5*r_S # Resistiant cells death rate
