...
raw_counts<- read_tsv("raw_counts.tsv")
...
# arbritrary selection of significant genes
...
## change the inf to big numbers as it will cause errors
res_df<- res_df %>%
...
# Filter out NA values from gene_list
gene_list <- gene_list[!is.na(names(gene_list))]
# Filter out rows with NA in ENTREZID
res_df <- res_df %>% filter(!is.na(ENTREZID))
